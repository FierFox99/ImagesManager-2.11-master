...
function webAPI_GET_ALL(queryString, successCallBack, errorCallBack) {
    ...
    $.ajax({
        ...
        success: (data, status, xhr) => { 
            //note: ajoute le url de la photo de user
            let ETag = xhr.getResponseHeader("ETag");
            console.log("webAPI_GET_ALL = currentETag:"+ETag);
...
function webAPI_GET_ALL_USER(successCallBack, errorCallBack) {
    $.ajax({
        ...
        success: (data, status, xhr) => { 
            ...
            let ETag = xhr.getResponseHeader("ETag");
            successCallBack(data, ETag); 
            console.log("webAPI_GET_ALL_USER - success", data); 
            console.log(`ETag: ${ETag}`);
        },
        error: function(jqXHR) {
            errorCallBack(jqXHR.status);
